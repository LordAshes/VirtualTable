  ...
  function initializeChat()
  {
	...
	div.style="Position: Absolute; Left: 1500px; Top: 40px;	Width: 400px; Height: 800px; Overflow: scroll; Border: 1px solid black;";
	document.body.appendChild(div);
	var in1 = document.createElement("input");
	in1.id = "ChatBox";
	in1.className = "ChatBar";
	in1.type = "text";
	in1.style="Position: Absolute; Left: 1520px; Top: 850px; Width: 260px;";
	...
	in2.type = "submit";
	in2.value = "Send";
	in2.style="Position: Absolute; Left: 1800px; Top: 850px;";
	in2.setAttribute("onClick","sendChat()");
	document.body.appendChild(in2);
	var btn = document.createElement("button");
	btn.id = "ChatBoxResize";
	btn.className = "ChatBar";
	btn.style = "Position: Absolute; Left: 1860px; Top: 850px; Width: 20px; Height:20px; background: url(/triangle_down.png)";
